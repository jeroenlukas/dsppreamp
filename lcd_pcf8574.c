...
void LCD_Init(void){
   ...
   // I2C1_MESSAGE_STATUS status;
    ...
    //i2c_write1ByteRegister(LCD_PCF8574_ADDR, uint8_t reg, uint8_t data);
   // i2c_writeNBytes(LCD_PCF8574_ADDR, "h", 1);
    ...
    //I2C_WriteByte(LCD_PCF8574_ADDR, LCD_INIT );
    i2c_simple_write_one_byte(I2C_ADDRESS_LCD, LCD_INIT);
...
void LCD_Clear(void){
    ...
    while (LCDbusy()){};
#else
    __delay_us(30000);  // this command takes a long time!
#endif
}
...
static void LCDwritePCF8574(unsigned char value) {
    ...
    //I2C_WriteByte(LCD_PCF8574_ADDR, value | _backlightval );
    i2c_simple_write_one_byte(I2C_ADDRESS_LCD, value | _backlightval);
}
...
// Extra commands
static void lcd_load_custom_characters(void)
{
    // Create custom characters
    const uint8_t lcd_custom_char_bar_1[8] = {
        0b00000,
        0b00000,
        0b00000,
        0b00000,
    ...
    const uint8_t lcd_custom_char_bar_2[8] = {
        0b00000,
        0b00000,
        0b00000,
        0b00000,
    ...
    const uint8_t lcd_custom_char_bar_3[8] = {
        0b00000,
        0b00000,
        0b00000,
        0b00000,
    ...
    const uint8_t lcd_custom_char_bar_4[8] = {
        0b00000,
        0b00000,
        0b00000,
        0b00000,
    ...
    const uint8_t lcd_custom_char_bar_5[8] = {
        0b00000,
        0b00000,
        0b00000,
        0b11111,
    ...
    const uint8_t lcd_custom_char_bar_6[8] = {
        0b00000,
        0b00000,
        0b11111,
        0b11111,
    ...
    const uint8_t lcd_custom_char_bar_7[8] = {
        0b00000,
        0b11111,
        0b11111,
        0b11111,
    ...
    LCDcreateChar(LCD_CC_BAR_1, lcd_custom_char_bar_1);
    LCDcreateChar(LCD_CC_BAR_2, lcd_custom_char_bar_2);
    LCDcreateChar(LCD_CC_BAR_3, lcd_custom_char_bar_3);
    LCDcreateChar(LCD_CC_BAR_4, lcd_custom_char_bar_4);
    LCDcreateChar(LCD_CC_BAR_5, lcd_custom_char_bar_5);
    LCDcreateChar(LCD_CC_BAR_6, lcd_custom_char_bar_6);
    LCDcreateChar(LCD_CC_BAR_7, lcd_custom_char_bar_7);
}